    ...
    return (
        <div className="flex flex-col vh-100%">
            ...
            <div className="flex flex-col mx-auto w-[440px] items-center border-2 rounded-lg mb-[100px]">
                <p className="text-[#121316] text-[32px] font-extrabold my-8">Бүртгүүлэх</p>
                ...
                <button className="flex items-center bg-[#F7F7F8] border-2 min-w-[360px] h-[56px] my-3 justify-center">
                    <img src="/_CompanyLogo.png" alt="logo" className="w-[20px] h-[20px] m-[17px]"/>
                    <p>Google-ээр нэвтрэх</p>
                </button>
                <button className="flex items-center bg-[#F7F7F8] border-2 min-w-[360px] h-[56px] my-3 justify-center">
                    <img src="/windows.png" alt="logo" className="w-[20px] h-[20px] m-[17px]"/>
                    <p>Microsoft-оор нэвтрэх</p>
                </button>
                <button className="flex items-center bg-[#F7F7F8] border-2 min-w-[360px] h-[56px] my-3 justify-center">
                    <img src="/apple.png" alt="logo" className="w-[20px] h-[20px] m-[17px]"/>
            ...
            <div className="text-[#a2a2b2] flex mx-auto my-[14px]">© 2023 Pinecone</div>
        </div>
    );
} 